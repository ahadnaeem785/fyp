  ...
  return (
    <div className=''>
        <ul className='flex justify-between items-center py-2 pl-8 pr-4'>
            ...
            <Link href={"/"} className=''><li><div className='flex justify-center items-center ml-6'><Image src={require("../public/pictures/logo.png")} alt='logo' height={100} width={100}/> <span className='text-[#ffcc00]/80 font-semibold'>SHAPE YOUR STYLE</span></div></li></Link>
